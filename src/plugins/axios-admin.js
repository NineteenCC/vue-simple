...
const instance = axios.create({
    baseURL: 'http://127.0.0.1:30001/tmsflowplatform', // ✅ 后端统一前缀，如 http://localhost:8080/api
    timeout: 10000,  // ⏱️ 请求超时时间，单位 ms
    headers: {
        'Content-Type': 'application/json',
        'workflow_authorization': 'QkVFQ0FERkE0RkFGQURCODU0OTVEQUU0NkJCRTAyOEE6YjdhZmJhNGYtYTViMC00MDc0LTk5YWItZjMxNzFlMzc1NzZl',
    },
    xsrfCookieName: '',
    xsrfHeaderName: '',
});
...
export default {
    install(Vue) {
        Vue.prototype.$http_admin = instance; // 🔄 挂载配置好的 axios 实例
    }
};